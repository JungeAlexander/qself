# AUTOGENERATED! DO NOT EDIT! File to edit: ../01_oura_models.ipynb.

# %% auto 0
__all__ = ['OuraBaseResponse', 'WorkoutIntensityEnum', 'OuraGenericData', 'OuraGenericResponse', 'OuraWorkoutData',
           'OuraWorkoutResponse']

# %% ../01_oura_models.ipynb 2
import datetime
